...
import com.pateo.yudo.radio.dispatcher.RxActionDispatch;

/**
 * RxStore is an abstract class that will handle the subscription with the dispatcher
 * in order to receive theimport com.pateo.commonlibrary.dispatcher.Dispatcher;
 * import com.pateo.commonlibrary.dispatcher.RxBus;
 * import com.pateo.commonlibrary.dispatcher.RxViewDispatch;
 * import com.pateo.commonlibrary.store.RxStore;
 * import com.pateo.commonlibrary.utils.SubscriptionManager; actions.
 ...
 * by the {@link com.pateo.yudo.radio.dispatcher.action.RxActionCreator}
 */
